...
ErrplaneMetrics.prototype.time=function(options,functionToTime){var startTime=new Date()-0
functionToTime();var endTime=new Date()-0
if(options.metricName){this.errplaneApi.report(options.metricName,{value:endTime-startTime,context:options.context});}}
